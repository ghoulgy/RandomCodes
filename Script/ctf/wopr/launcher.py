...
h = list(wrong())
print(h) # [233, 248, 38, 45, 221, 25, 102, 11, 32, 177, 100, 37, 129, 164, 46, 131]
h = [h[i] ^ xor[i] for i in range(16)]
print(h) # [61, 90, 212, 247, 184, 116, 84, 20, 93, 193, 157, 118, 182, 31, 173, 77]
t.write('''
...
if b != h:
    ...
    launch_code = [18, 193, 195, 201, 62, 72, 53, 182, 177, 144, 246, 62, 207, 7, 42, 9]
